...
export const dietQuestions = [
  ...
  // gain weight amount
  {
    ...
    min: 1,
    max: 10,
    question: "How much do you want to gain?",
    description:
      "Think about the weight that you dreamed of to gain, realisticaly.",
    id: "gainWeight",
    jump: 2,
  },
  // lose weight amount
  {
    ...
    min: 1,
    max: 10,
    question: "How much do you want to lose?",
    description:
      "Think about the weight that you dreamed of losing, realisticaly.",
    id: "loseWeight",
    jump: 1,
  },
  // duration
